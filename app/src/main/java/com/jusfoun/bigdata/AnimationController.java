 ...
 * 动画控制器
 * <p/>
 * Create by lzx on 2016-8-5 22:06:01
 */
public class AnimationController {
    ...
    private static void baseIn(View view, Animation animation, long durationMillis, long delayMillis, AnimationListener listener) {
        setEffect(animation, Default, durationMillis, delayMillis);
    ...
    private static void baseOut(View view, Animation animation, long durationMillis, long delayMillis) {
        baseOut(view, animation, durationMillis, delayMillis, new MyAnimationListener(view));
    }

    private static void baseOut(View view, Animation animation, long durationMillis, long delayMillis, AnimationListener listener) {
        setEffect(animation, Default, durationMillis, delayMillis);
        animation.setAnimationListener(listener);
        view.startAnimation(animation);
    }
     ...
     * @param delayMillis    延迟多久执行动画 单位毫秒
     */
    public static void slideBottomIn(View view, long durationMillis, long delayMillis, AnimationListener listener) {
//        TranslateAnimation animation = new TranslateAnimation(rela2, 0, rela2, 0, rela2, 1, rela2, 0);
        TranslateAnimation animation = new TranslateAnimation(0, 0, view.getHeight(), 0);
        baseIn(view, animation, durationMillis, delayMillis, listener);
    }
     ...
     * @param delayMillis    延迟多久执行动画 单位毫秒
     */
    public static void slideBottomOut(View view, long durationMillis, long delayMillis, AnimationListener listener) {
//        TranslateAnimation animation = new TranslateAnimation(rela2, 0, rela2, 0, rela2, 0, rela2, 1);
        TranslateAnimation animation = new TranslateAnimation(0, 0, 0, view.getHeight());
        baseOut(view, animation, durationMillis, delayMillis, listener);
    }
