...
public class ColorPointHintView extends ShapeHintView {
    ...
    public Drawable makeFocusDrawable() {
        ...
        dot_focus.setCornerRadius(PhoneUtil.dip2px(getContext(), 4));
        dot_focus.setSize(PhoneUtil.dip2px(getContext(), 8), PhoneUtil.dip2px(getContext(), 8));
        return dot_focus;
    }
    ...
    public Drawable makeNormalDrawable() {
        ...
        dot_normal.setCornerRadius(PhoneUtil.dip2px(getContext(), 4));
        dot_normal.setSize(PhoneUtil.dip2px(getContext(), 8), PhoneUtil.dip2px(getContext(), 8));
        return dot_normal;
    }
}
